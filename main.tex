...
\pagestyle{fancy}
	...
	%Fonud at when
	\gls{scz} is a detrimental psychiatric disorder affecting $\approx1\%$ of the population.
	It was first discovered at ???? by ???? and every since then, researchers have tried to understand the disease mechanisms and identify the cause of the disorder in the hope of finding a cure. 
	\subsection{Phenotype}
	\gls{scz} patient typically demonstrate ....
	According to the DSM IV, a diagnosis of \gls{scz} can be made when the patient demonstrate....
