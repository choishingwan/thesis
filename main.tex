...
\setlength{\parskip}{0.75em}
	...
	The enrichment of immune related enhancers provide the first genetic support of the involvement of the immune system in the etiology of \glng{scz}.
	...
	Unlike the result form the \gls{SNP} \gls{GWAS}, the \gls{cnv} identified were rare($\le12$ in 4,719 samples) and has a relative large effect (e.g. 17q12 duplications has an odd ratio of 4.16). 
	...
	Although the \gls{GWAS} in \glng{scz} seems to return a lot of interesting results, the question remains: How much do we know about \glng{scz}? And how much of \glng{scz} do we not know?
	...
	Following on their observation, 
	...
	One of the ultimate goal in the research of \glng{scz} is to identify an effective treatment for the disorder.	
	To date, despite the increasing research efforts in \glng{scz}, there was no effective cure for \glng{scz}.
	So far, the treatment method of \glng{scz} were the use of antipsychotic drugs where there is a large variability between individuals in their response to the drugs.
