...
\pagestyle{fancy}
	...
	Arguably, the most important first step to any \glsentrylong{scz} is to have a robust disease diagnosis.
	
	\section{Diagnosis}
	
	\section{Heritability of \glsentrylong{scz}}
	The important first step was to test whether \glsentrylong{scz} is heritable or not.
