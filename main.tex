...
\setlength{\parskip}{0.75em}
	...
	% Still need to continue slightly here.
	% Should mainly talk about the important of such findings
	
	It was important for one to understand whether if \glng{scz} was more affected by the genetic or the environmental factors. 
	The evidence so far seems to suggest that \glng{scz} was affected by both. 
	To understand whether if \glng{scz} was more affected by variance in genetic factors or environmental factors, we will need to estimate the heritability of \glng{scz}.
