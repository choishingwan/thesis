...
\frontmatter 
	...
	On the other hand, it was observed that prenatal infection increases the risk of schizophrenia. 
	Of all environmental risk factors, prenatal infection is the largest risk factor.
	Moreover, recent study has shown that a n-3 \gls{pufa} rich diet can help to reduce the schizophrenia-like phenotype in mice exposed to early \gls{mia} insults.
	It is therefore important to understand how \gls{mia} and the n-3 \gls{pufa} rich diet affects the molecular signature within the brain.
	...
	We also performed a pilot study to investigate the effect of n-3 \gls{pufa} rich diet on the gene expression pattern of \gls{mia} exposed mice cerebellum using the \gls{polyic} mouse model.
	In study, we have successfully identify \textit{Sgk1}, a gene that can regulates glutamatergic system, as a possible candidate that were mediated by n-3 \gls{pufa} rich diet in the \gls{polyic} exposed mice. 
	Pathways related to neural functioning and calcium ion signally were also found to be significant in when investigating the effect of \gls{mia} in the cerebellum.
	Together with the accumulating evidence that deregulation of synapse might be involved in \glng{scz}, our pilot study suggests that future studies focusing on manipulations of the genes related to neural function as well as glutamate-related genes such as \textit{Sgk1}, might help to identify molecular signal of \glng{scz} related to \gls{mia} and that were affected by the n-3 \gls{pufa} rich diet, hence provide novel targets for  treatment in \glng{scz}.
	\begin{flushright}
		(390 words)
	\end{flushright}
	\glsresetall
	...
	\vspace{1cm}
	This thesis would not be possible without my supervisors, Processor Pak Sham, Dr Stacey Cherny and Dr Wanling Yeung and I would like to thank them for taking me in and giving my guidance whenever I need during my study.
