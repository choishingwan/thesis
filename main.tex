...
\setlength{\parskip}{0.75em}
	...
	The fundamental question to ask would be whether if this aggregation has an environmental or genetic origin.
	
	One key concept in finding the \emph{proportion} of genetic and environmental contribution is \emph{heritability}. 
	Heritability is defined as the proportion of variation in phenotype explained by variation in genetics. 
