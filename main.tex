...
\setlength{\parskip}{0.75em}
	...
	% MIA 
	% Drug abuse
	% Only explain small amount of case
	% Observed segregation in family
	% Nature? Nurture?
	...
	% population based
	% can change if one factor change 
	As heritability is a populational measurement of the \emph{ratio} between different variance, change in any of the measurement (e.g. $\sigma_G^2$ or $\sigma_E^2$) will also affect the estimation of heritability.
