...
\setlength{\parskip}{0.75em}
	...
	% Evidence converge?
	% How much of the genetics have we found?
	% Need heritability estimation based on the results
	% Usually not conduct with family data as it require large sample size
	% Can we estimate heritability without using family samples?
	% GCTA
	
	\subsection{\glng{gcta}}
	% Advantages when compared to twin study and adoption studies
	% Doesn't need family data
	% Use the crptal relationship between individual 
	% Calculate the genetic distance between samples 
	% Use that in place of the relationship stuff
	% Perform linear mix model for the estimation of heritability
	% Problem of this method
	% Cannot use test statistics
	% Need to use another method as most only provide test statistics
