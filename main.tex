...
\frontmatter 
	...
	\cleardoublepage
	\phantomsection
	\contentsline{toc}{chapter}{Declaration}
...
\setlength{\parskip}{0.75em}
	...
	One of the most fundamental question in the study of \glng{scz} is that whether if it is environmental or inherited disorder.
	The common method for calculating the portion of genetic and environmental contribution was by the familial studies, especially twin studies.
	On 2003, \cite{Sullivan2003} has conducted a quantitative meta-analysis of the published twin studies of \glng{scz}.
	
	A total of 12 studies were included in the meta-analysis. 
	By taking into account of the ascertainment bias, the authors found that the common environmental effects on liability to \glng{scz} to be $11\%$ with a $95\%$ \gls{ci} ranged from $3\%-19\%$, suggesting there to be a non-zero contribution of environmental influence.
	
	Considering the environments shared by twin pairs tends to diverge over time, the authors therefore suggested that the environmental effects would be most likely to occur early in life, concurring with the neurodevelopmental hypothesis of \glng{scz}.
	
	On the other hand, they also found that the heritability of \glng{scz} was around $81\%$ with a $95\%$ \gls{ci} ranged from $73\%-90\%$, suggesting that \glng{scz} is predominantly a genetic disorder
	Because of its high heritability, the identification of the genes responsible will be crucial for the understanding of the disease and the development of treatments.
	
	
	\section{Genetic Analysis of Schizophrenia}
	As \glng{scz} is highly heritable, it has attracted much attention from the scientific community to 
	% Brief describe twins and family study. 
	% Present data which shows increased risk in schizophrenia for first degree relatives
	% Explain that schizophrenia is heritable, dominently genetic
	% Therefore it is important to study it from the angle of genetics
	...
	Efforts have been made to identify the genetic cause of \glng{scz}.
