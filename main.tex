...
\setlength{\parskip}{0.75em}
	...
	By using information from all \glspl{SNP} and taking into account of the \gls{LD} structure, \gls{ldsc} might help to partition the heritability and therefore provide some useful insight into the disease etiology.
