...
To capture the full spectrum of trait complexity (e.g. Mendelian to Complex Traits), we selected number of causal SNP to be $k\in(1,10,100)$ such that effect size$\in(0,\frac{1}{k})$.
