\chapter{Heritability Estimation}
	...
	\section{Result}
		...
		\begin{figure}
			%Should we flat the heritability estimation such that it is always [0,1]?
			\centering
			\centering
			\subfloat[SHREK]{
				\scalebox{.4}{\includegraphics{figure/quantitative/shrek_50k_10c_meanH.png}}
				\label{fig:50k10cQtmeanS}
			}
			\subfloat[GCTA]{
				\scalebox{.4}{\includegraphics{figure/quantitative/gcta_50k_10c_meanH.png}}
				\label{fig:50k10cQtmeanG}
			}\\
			\subfloat[LDSC with fix intercept]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldsc_50k_10c_meanH.png}}
				\label{fig:50k10cQtmeanL}
			}
			\subfloat[LDSC with intercept estimation]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldscIn_50k_10c_meanH.png}}
				\label{fig:50k10cQtmeanI}
			}
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants.
			The mean estimation of each round of simulation were plotted against the empirical heritability simulated.
				It was observed that \gls{shrek} has the highest $R^2$ and with \gls{mse} lower than that of \gls{ldsc}} 
		...
		\begin{figure}
			...
			\centering
			\subfloat[SHREK]{
				\scalebox{.4}{\includegraphics{figure/quantitative/shrek_50k_10c_varH.png}}
				\label{fig:50k10cQtvarS}
			}
			\subfloat[GCTA]{
				\scalebox{.4}{\includegraphics{figure/quantitative/gcta_50k_10c_varH.png}}
				\label{fig:50k10cQtvarG}
			}\\
			\subfloat[LDSC with fix intercept]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldsc_50k_10c_varH.png}}
				\label{fig:50k10cQtvarL}
			}
			\subfloat[LDSC with intercept estimation]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldscIn_50k_10c_varH.png}}
				\label{fig:50k10cQtvarI}
			}
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants(Variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants (Variance).
		...
		\begin{figure}
			...
			\centering
			\subfloat[SHREK]{
				\scalebox{.4}{\includegraphics{figure/quantitative/shrek_50k_50c_meanH.png}}
				\label{fig:50k50cQtmeanS}
			}
			\subfloat[GCTA]{
				\scalebox{.4}{\includegraphics{figure/quantitative/gcta_50k_50c_meanH.png}}
				\label{fig:50k50cQtmeanG}
			}\\
			\subfloat[LDSC with fix intercept]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldsc_50k_50c_meanH.png}}
				\label{fig:50k50cQtmeanL}
			}
			\subfloat[LDSC with intercept estimation]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldscIn_50k_50c_meanH.png}}
				\label{fig:50k50cQtmeanI}
			}
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 50 causal variants]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 50 causal variants.
				The mean estimation of each round of simulation were plotted against the empirical heritability simulated.
		...
		\begin{figure}
			...
			\centering
			\subfloat[SHREK]{
				\scalebox{.4}{\includegraphics{figure/quantitative/shrek_50k_50c_varH.png}}
				\label{fig:50k50cQtvarS}
			}
			\subfloat[GCTA]{
				\scalebox{.4}{\includegraphics{figure/quantitative/gcta_50k_50c_varH.png}}
				\label{fig:50k50cQtvarG}
			}\\
			\subfloat[LDSC with fix intercept]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldsc_50k_50c_varH.png}}
				\label{fig:50k50cQtvarL}
			}
			\subfloat[LDSC with intercept estimation]{
				\scalebox{.4}{\includegraphics{figure/quantitative/ldscIn_50k_50c_varH.png}}
				\label{fig:50k50cQtvarI}
			}
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 50 causal variants(Variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 50 causal variants (Variance).
