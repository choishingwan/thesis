...
%			\begin{figure}
%				\caption[Cumulative Distribution of ``gap'' of the LD matrix]{Cumulative Distribution of ``gap'' of the LD matrix.
%				The vertical line indicate the full rank. 
%				If 
%				It can be observed that there is a huge increase in ``gap'' before full rank is achieved. 
