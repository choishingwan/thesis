...
% Need to stress that we are only calculating the narrow sense heritability
	...
	Its ability in delineating the contributions from confounding factors such as population stratification and common \glspl{SNP} were vital to its success.
	...
	In this chapter, we will first introduce \gls{shrek}, an alternative algorithm to \gls{ldsc} for the robust estimation of \gls{SNP} heritability based on \gls{GWAS} summary statistics.
...
\end{table}
	...
	Intriguingly the same overestimation was not observed in \gls{ldsc}.
