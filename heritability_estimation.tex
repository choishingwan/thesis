...
% Need to stress that we are only calculating the narrow sense heritability
	...
	\section{Result}
		...
		\begin{figure}
			...
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants with same effect size (variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants with same effect size (variance).} 
		...
		\begin{figure}
			...
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 50 causal variants with same effect size (variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 50 causal variants with same effect size (variance).} 
		...
		\begin{figure}
			...
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 100 causal variants with same effect size (variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 100 causal variants with same effect size (variance).} 
		...
		\begin{figure}
			...
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 250 causal variants with same effect size (variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 250 causal variants with same effect size (variance).} 
		...
		\begin{figure}
			...
			\caption[Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants with random effect size (variance)]
			{Simulation of Quantitative Traits with 50k \glsentryshortpl{SNP} and 10 causal variants with random effect size (variance).} 
