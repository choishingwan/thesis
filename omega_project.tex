...
In total, 29 unique pathways were included in the analysis were 26 of them were found to have non-negative contribution to the heritability of \glng{scz}.
...
\begin{landscape}
	...
	\begin{table}
		...
		This suggest that it is likely for the differential gene expression induced by \gls{mia} and genetic mutation might have act upon the same functional pathway in the development of \glng{scz}.
		}
...
%TODO explain how neuronal system related to schizophrenia
...
Based on our results, it is very likely that the differential gene expression in the cerebellum induced by early \gls{mia} events and the genetic variants to act upon the same pathways in the development of \glng{scz}.
...
Intriguingly, those were also the only 2 pathways from the n-3 \gls{pufa} rich diet that were found to be significantly contributing to the \gls{SNP} heritability of \glng{scz} and they were both related to the extracellular matrix. 
%TODO extracellular matrix

There are emerging evidence suggesting that the \gls{ecm} abnormality might be associated with \glng{scz} \citep{Berretta2012}.
...
These pathways were also the only pathways that were affected by \gls{mia}, n-3 \gls{pufa} rich diet and also contribute for a significant disproportionated amount to the \gls{SNP} heritability of \glng{scz}.
